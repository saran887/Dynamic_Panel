  ...
  return (
    ...
    <div className="h-full w-full bg-white overflow-hidden flex flex-col">
      <div className="flex flex-col w-full bg-white items-start px-4 sm:px-6 pb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="flex items-center gap-2 font-medium whitespace-nowrap">
        ...
        {/* Table Container - scrollable and responsive */}
        ...
        {/* Pagination - moved below table container */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-4 py-3 bg-white border-t gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <span className="text-sm text-gray-700 text-center sm:text-left">
              Showing {blogs.length > 0 ? startIndex + 1 : 0} to {Math.min(endIndex, blogs.length)} of {blogs.length} entries
            </span>
          </div>
            ...
            {showForm && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <form onSubmit={handleAddBlog} className="space-y-3 px-6 pb-6">
                    <div>
